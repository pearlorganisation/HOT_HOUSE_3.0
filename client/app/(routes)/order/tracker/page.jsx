...
const page = () => {
  ...
  return (
    <>
      {/* Add Head for meta tags, title, and script */}
      <Head>
        <title>Order Success | Pizza Inno Watford</title>
        <meta name="description" content="Thank you for your order at Pizza Inno Watford. Your order is being processed." />
        <meta name="robots" content="noindex, nofollow" /> {/* Optional: to prevent indexing of this page */}
        
        {/* Add your script inside the head section */}
        <script
