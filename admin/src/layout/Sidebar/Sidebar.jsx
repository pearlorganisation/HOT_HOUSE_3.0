    ...
    <>
      ...
      <div className="flex h-screen fixed">
        <aside
          ...
          className={` top-0 bottom-0 left-0 lg:static  z-40 flex w-72 flex-col  font-medium bg-[#DD1718] transition-transform lg:translate-x-0 ${isSideNavOpen ? "translate-x-0" : " -translate-x-full"
            }`}
        >
